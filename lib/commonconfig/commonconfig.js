...
import { flattenData as flattenConfigData, unflattenData as expandConfigData, mergeConfigLayers, cleanConfigData, buildDefaultsFromSchema, unwrapRootArrayFromSchemaShape } from './config-utils.js';
...
export default class ConfigBase {
  ...
  buildDefaultFromSchema(schema = this.schema) {
    return buildDefaultsFromSchema(schema);
  }
