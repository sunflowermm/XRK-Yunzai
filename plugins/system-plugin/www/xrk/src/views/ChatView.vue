...
const needsDevice = computed(() => chat.mode === 'event');
...
<template>
  ...
  >
    ...
    <section class="chat-main brutal-card">
      <header>
        <div class="title">
          <button
            type="button"
          ...
          <span
            class="emo-dot"
            :data-emo="headerEmotion"
            aria-hidden="true"
          >{{ emotionGlyph[headerEmotion] }}</span>
      ...
      <footer class="composer">
        ...
        <NInput
          ...
          placeholder="Enter 发送 · Shift+Enter 换行 · 可粘贴/拖拽"
