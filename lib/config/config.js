...
import { PORT_CONFIG_FILES, DEFAULT_CONFIG_DIR, SERVER_BOTS_DIR } from './config-constants.js';
...
class Cfg {
  ...
  /** 当 aistream.enabled 为 false 时，StreamLoader 不加载工作流；此处仍返回合并配置供 LLMFactory 等使用 */
  get aistream() {
