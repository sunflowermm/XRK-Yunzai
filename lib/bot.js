...
export default class Bot extends EventEmitter {
  ...
  makeError(message, type = 'Error', details = {}) {
    ...
    const isSilent = !!(details && (details.silent === true || details.quiet === true));
    const logLevel = (details && (details.logLevel || details.level)) ? (details.logLevel || details.level) : 'error';
