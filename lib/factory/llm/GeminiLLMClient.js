...
import { visionReferenceToGeminiInlineData } from '../../utils/llm/image-utils.js';
 ...
 * - 图片：`transformOpenAIStyleVisionMessages` 统一结构，`visionReferenceToGeminiInlineData` 下载/规范化后 inlineData
...
export default class GeminiLLMClient {
  ...
  async _toInlineData(url) {
    return visionReferenceToGeminiInlineData(url, this.config);
  }
