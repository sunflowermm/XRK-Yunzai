...
import { prepareVolcengineVisionMessages } from '../../utils/llm/image-utils.js';
...
export default class VolcengineLLMClient {
  ...
  async transformMessages(messages) {
    return prepareVolcengineVisionMessages(messages, this.config, { timeoutMs: this.timeout });
  }
