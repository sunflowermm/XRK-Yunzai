...
/**
 * Chat Completions 多模态统一入口：OpenAI 风格 text + image_url（各 LLM 工厂共用，避免重复 mode: openai）
 */
export async function transformOpenAIStyleVisionMessages(messages, config = {}, options = {}) {
