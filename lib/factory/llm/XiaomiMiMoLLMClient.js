...
export default class XiaomiMiMoLLMClient {
   ...
   * 支持高级参数：stop、tool_choice、tools、response_format
   */
  buildBody(messages, overrides = {}) {
    ...
    const body = {
      ...
      // 兼容 enableStream 配置：overrides 优先，其次读 config.enableStream
      stream: overrides.stream ?? this.config.enableStream ?? false,
