...
function getCacheConfig() {
  return getAiWorkflowConfigOptional().cache ?? {};
}
 ...
 */
export function shouldCacheWorkflowResult(stream, e, question, config = {}) {
  const cacheCfg = getCacheConfig();
 ...
 */
export function buildWorkflowCacheKey(streamName, e, question, config = {}) {
...
export function getWorkflowResultCache() {
  return ensureCache();
}

export function clearWorkflowResultCache() {
