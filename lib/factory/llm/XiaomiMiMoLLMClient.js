    ...
    for (let round = 0; round < maxToolRounds; round++) {
      ...
      if (extracted.tool_calls.length > 0) {
        ...
        if (this.config.enableTools === false || !MCPToolAdapter.hasTools()) {
          return finalizeLlmChatNonStreamContent(replyTracker, extracted.cleaned || '');
        }
        noteLlmChatToolCallsForReply(replyTracker, extracted.tool_calls);
      ...
      return finalizeLlmChatNonStreamContent(replyTracker, contentText);
    }
