...
class PluginsLoader {
  ...
  /**
   * 为事件对象挂载 isSr / isGs / isZzz 访问器（与 TRSS-Yunzai 一致）
   * @param {Object} e
   */
  setupGameEventProperties(e) {
    if (Object.prototype.hasOwnProperty.call(e, 'isSr')) return
  ...
  /**
   * 识别星铁 / 绝区零前缀并标准化命令（Runtime.init 之前调用，供 NoteUser 按 e.game 路由）
   * @param {Object} e
   */
  normalizeGameCommand(e) {
    if (!e?.msg) return

    this.setupGameEventProperties(e)
