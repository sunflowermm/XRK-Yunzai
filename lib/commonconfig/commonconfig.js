...
import { flattenData as flattenConfigData, unflattenData as expandConfigData, mergeConfigLayers, cleanConfigData, buildDefaultsFromSchema } from './config-utils.js';
...
export default class ConfigBase {
  ...
  _assertConfigSourcesExist(template, stored) {
    ...
    if (hasTemplate || hasStored) return;
