...
const icqqPath = path.resolve(process.cwd(), 'plugins/ICQQ-Plugin/node_modules/icqq/lib/message/elements.js');
if (FileUtils.existsSync(icqqPath)) {
  try {
    ...
    BotUtil.makeLog('debug', `[oicq] ICQQ segment 扩展失败: ${err?.message || err}`, 'oicq');
  }
}
